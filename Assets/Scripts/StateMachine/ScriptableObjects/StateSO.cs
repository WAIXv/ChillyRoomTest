...
namespace StateMachine
{
	...
	public class StateSO : ScriptableObject
	{
		...
		/// </summary>
		internal State GetState(global::StateMachine.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
		...
		private static StateAction[] GetActions(StateActionSO[] scriptableActions,
			global::StateMachine.StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
		{
